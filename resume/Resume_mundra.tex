...
\begin{document}
\makeheading{Jay Dave Mundrawala \hfill \tiny{Revised: June 2010}}
...
%
Data Mining, Information Retrieval, Hardware Design, Digital Image Processing
...
\textbf{MITRE}
\begin{outerlist}
	\item[] \textit{Information Systems Engineer} \hfill \textbf{June. 2010 to present}
\end{outerlist}

\textbf{Information Retrieval Laboratory} - Illinois Institute of Technology, Chicago, IL
\begin{outerlist}
	\item[] \textit{Research Assistant} \hfill \textbf{May. 2008 to May 2010}
	\begin{innerlist}
		...
		\item Ran tests to study efficiency of selected search engines
